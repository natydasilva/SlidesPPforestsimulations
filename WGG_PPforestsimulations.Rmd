...
* Let $B=(1,\ldots 1)$ and $\sigma^*=B^T\Sigma B$ then $Z_i\sim N(0,\sigma^*)$
...
* $x_{2,i} = \alpha + \beta x_{1,i} + \epsilon_i$ 
...
---------         | -------                |
 $\sigma^2$       | $\{1, 10, 20, 30\}$    |
Classes           | $2$                    |
$\beta_{g1}, \beta_{g2}$ | $\{0,2^1, 2^2,2^3, 2^4, 2^5\}$       |
$\alpha_{g1}$ | 0 |
$\alpha_{g2}$ | $\{5, 10, 20, 30\}$ 
Replicates  | $20$                   |
n | 200
...
## <span style="color:#26734d">Simulation 3, results $alpah_{g2}=5$</span>
